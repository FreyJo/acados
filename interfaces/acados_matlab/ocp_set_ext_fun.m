...
if (strcmp(model_struct.dyn_type, 'explicit'))
	...
	mex_names = {mex_names{:} ...
		'ocp_set_ext_fun_dyn_0_expl_ode_fun' ...
		'ocp_set_ext_fun_dyn_0_expl_vde_for' ...
		'ocp_set_ext_fun_dyn_0_expl_vde_adj' ...
		'ocp_set_ext_fun_dyn_0_expl_ode_hes' ...
		};
	phase = {phase{:}, 0, 0, 0, 0};
...
elseif (strcmp(model_struct.dyn_type, 'implicit'))
	...
	if (strcmp(opts_struct.sim_method, 'irk'))
		...
		mex_names = {mex_names{:} ...
			'ocp_set_ext_fun_dyn_0_impl_ode_fun' ...
			'ocp_set_ext_fun_dyn_0_impl_ode_fun_jac_x_xdot' ...
			'ocp_set_ext_fun_dyn_0_impl_ode_jac_x_xdot_u' ...
			'ocp_set_ext_fun_dyn_0_impl_ode_hess' ...
			};
		phase = {phase{:}, 0, 0, 0, 0};
		phase_start = {phase_start{:}, 0, 0, 0, 0};
		phase_end = {phase_end{:}, N-1, N-1, N-1, N-1};
	...
	elseif (strcmp(opts_struct.sim_method, 'irk_gnsf'))
		...
		mex_names = {mex_names{:} ...
			'ocp_set_ext_fun_dyn_0_gnsf_f_lo_fun_jac_x1k1uz' ...
			'ocp_set_ext_fun_dyn_0_gnsf_get_matrices_fun' ...
			'ocp_set_ext_fun_dyn_0_gnsf_phi_fun' ...
			'ocp_set_ext_fun_dyn_0_gnsf_phi_fun_jac_y' ...
			'ocp_set_ext_fun_dyn_0_gnsf_phi_jac_y_uhat' ...
			'ocp_set_ext_fun_dyn_0_gnsf_phi_hess' ...
			};
...
elseif (strcmp(model_struct.dyn_type, 'discrete'))
	...
	mex_names = {mex_names{:} ...
		'ocp_set_ext_fun_dyn_0_disc_phi_fun_jac' ...
		'ocp_set_ext_fun_dyn_0_disc_phi_fun_jac_hess' ...
		};
	phase = {phase{:}, 0, 0};
...
if (strcmp(model_struct.constr_type, 'bgh') && (isfield(model_struct, 'dim_nh') && model_struct.dim_nh>0))
	...
	mex_names = {mex_names{:} ...
		'ocp_set_ext_fun_constr_0_h_fun_jac_ut_xt' ...
		'ocp_set_ext_fun_constr_0_h_fun_jac_ut_xt_hess' ...
		};
	phase = {phase{:}, 0, 0};
	phase_start = {phase_start{:}, 0, 0};
	phase_end = {phase_end{:}, N-1, N-1};
...
if (strcmp(model_struct.constr_type, 'bgh') && (isfield(model_struct, 'dim_nh_e') && model_struct.dim_nh_e>0))
	...
	mex_names = {mex_names{:} ...
		'ocp_set_ext_fun_constr_1_h_fun_jac_ut_xt' ...
		'ocp_set_ext_fun_constr_1_h_fun_jac_ut_xt_hess' ...
		};
	phase = {phase{:}, 1, 1};
...
if (strcmp(model_struct.cost_type, 'nonlinear_ls'))
	...
	mex_names = {mex_names{:} ...
		'ocp_set_ext_fun_cost_0_y_fun_jac_ut_xt' ...
		'ocp_set_ext_fun_cost_0_y_hess' ...
		};
	phase = {phase{:}, 0, 0};
	phase_start = {phase_start{:}, 0, 0};
	phase_end = {phase_end{:}, N-1, N-1};
...
if (strcmp(model_struct.cost_type_e, 'nonlinear_ls'))
	...
	mex_names = {mex_names{:} ...
		'ocp_set_ext_fun_cost_1_y_fun_jac_ut_xt' ...
		'ocp_set_ext_fun_cost_1_y_hess' ...
		};
	phase = {phase{:}, 1, 1};
	phase_start = {phase_start{:}, N, N};
	phase_end = {phase_end{:}, N, N};
...
if (strcmp(model_struct.cost_type, 'ext_cost'))
	...
	mex_names = {mex_names{:} ...
		'ocp_set_ext_fun_cost_0_ext_cost_jac_hes' ...
		};
	phase = {phase{:}, 0};
...
if (strcmp(model_struct.cost_type_e, 'ext_cost'))
	...
	mex_names = {mex_names{:} ...
		'ocp_set_ext_fun_cost_1_ext_cost_jac_hes' ...
		};
	phase = {phase{:}, 1};
