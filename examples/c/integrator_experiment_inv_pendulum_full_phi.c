...
************************************************/
    ...
    ************************************************/
    ...
    phi_fun.casadi_fun            = &inv_pendulum_full_phi_phi_fun;
    phi_fun.casadi_work           = &inv_pendulum_full_phi_phi_fun_work;
    phi_fun.casadi_sparsity_in    = &inv_pendulum_full_phi_phi_fun_sparsity_in;
    phi_fun.casadi_sparsity_out   = &inv_pendulum_full_phi_phi_fun_sparsity_out;
    phi_fun.casadi_n_in           = &inv_pendulum_full_phi_phi_fun_n_in;
    phi_fun.casadi_n_out          = &inv_pendulum_full_phi_phi_fun_n_out;
    external_function_casadi_create(&phi_fun);

    // phi_fun_jac_y
    external_function_casadi phi_fun_jac_y;
    phi_fun_jac_y.casadi_fun            = &inv_pendulum_full_phi_phi_fun_jac_y;
    phi_fun_jac_y.casadi_work           = &inv_pendulum_full_phi_phi_fun_jac_y_work;
    phi_fun_jac_y.casadi_sparsity_in    = &inv_pendulum_full_phi_phi_fun_jac_y_sparsity_in;
    phi_fun_jac_y.casadi_sparsity_out   = &inv_pendulum_full_phi_phi_fun_jac_y_sparsity_out;
    phi_fun_jac_y.casadi_n_in           = &inv_pendulum_full_phi_phi_fun_jac_y_n_in;
    phi_fun_jac_y.casadi_n_out          = &inv_pendulum_full_phi_phi_fun_jac_y_n_out;
    external_function_casadi_create(&phi_fun_jac_y);

    // phi_jac_y_uhat
    external_function_casadi phi_jac_y_uhat;
    phi_jac_y_uhat.casadi_fun                = &inv_pendulum_full_phi_phi_jac_y_uhat;
    phi_jac_y_uhat.casadi_work               = &inv_pendulum_full_phi_phi_jac_y_uhat_work;
    phi_jac_y_uhat.casadi_sparsity_in        = &inv_pendulum_full_phi_phi_jac_y_uhat_sparsity_in;
    phi_jac_y_uhat.casadi_sparsity_out       = &inv_pendulum_full_phi_phi_jac_y_uhat_sparsity_out;
    phi_jac_y_uhat.casadi_n_in               = &inv_pendulum_full_phi_phi_jac_y_uhat_n_in;
    phi_jac_y_uhat.casadi_n_out              = &inv_pendulum_full_phi_phi_jac_y_uhat_n_out;
    external_function_casadi_create(&phi_jac_y_uhat);

    // f_lo_fun_jac_x1k1uz
    external_function_casadi f_lo_fun_jac_x1k1uz;
    f_lo_fun_jac_x1k1uz.casadi_fun            = &inv_pendulum_full_phi_f_lo_fun_jac_x1k1uz;
    f_lo_fun_jac_x1k1uz.casadi_work           = &inv_pendulum_full_phi_f_lo_fun_jac_x1k1uz_work;
    f_lo_fun_jac_x1k1uz.casadi_sparsity_in    = &inv_pendulum_full_phi_f_lo_fun_jac_x1k1uz_sparsity_in;
    f_lo_fun_jac_x1k1uz.casadi_sparsity_out   = &inv_pendulum_full_phi_f_lo_fun_jac_x1k1uz_sparsity_out;
    f_lo_fun_jac_x1k1uz.casadi_n_in           = &inv_pendulum_full_phi_f_lo_fun_jac_x1k1uz_n_in;
    f_lo_fun_jac_x1k1uz.casadi_n_out          = &inv_pendulum_full_phi_f_lo_fun_jac_x1k1uz_n_out;
    external_function_casadi_create(&f_lo_fun_jac_x1k1uz);

    // get_matrices_fun
    external_function_casadi get_matrices_fun;
    get_matrices_fun.casadi_fun            = &inv_pendulum_full_phi_get_matrices_fun;
    get_matrices_fun.casadi_work           = &inv_pendulum_full_phi_get_matrices_fun_work;
    get_matrices_fun.casadi_sparsity_in    = &inv_pendulum_full_phi_get_matrices_fun_sparsity_in;
    get_matrices_fun.casadi_sparsity_out   = &inv_pendulum_full_phi_get_matrices_fun_sparsity_out;
    get_matrices_fun.casadi_n_in           = &inv_pendulum_full_phi_get_matrices_fun_n_in;
    get_matrices_fun.casadi_n_out          = &inv_pendulum_full_phi_get_matrices_fun_n_out;
...
************************************************/
	...
	/* print results to file */
		...
		// append model name
		strcat(export_filename, "inv_pendulum_full_phi_");
		if (nss == 2){
